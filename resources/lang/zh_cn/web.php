...
return array(
    ...
    'NEW_TAG'=>'新的Tag',
    'TAG_NAME' => 'Tag名称',
    //admin/page/create.blade.php
    'CREATE' => '创建',
    //view/admim/page/form-content.blade.php
    'FORM_CONTENT_URI' => '页面uri',
    'FORM_CONTENT_NAME' => '页面名称',
    'FORM_CONTENT' => '页面内容',
    ...
    'COMMENT_TYPE'=>'评论类型',
    'COMMENT_RAW' => '自带评论',
    'ALLOW_RESOURCE_COMMENT' => '是否允许评论',
    'DISALLOW_COMMENT' => '禁止评论',
    'ALLOW_COMMENT' => '允许评论',
    'DISPLAY_AT_INDEX' => '显示在主页',
    'HIDE_AT_INDEX' => '不显示在主页',
    'ORDER'=>'顺序',
    //view/admin/partials/image_list.blade.php
    'ORIGINAL_IMAGE' => '原图',
    'COPY' => '复制',
    'CONFIRM_TO_REMOVE'=>'确定删除',
    'REMOVE' => '删除',
    'NO_IMAGE'=>'没有图片',
    //view/admin/partials/ip_button.blade.php
    'BLOCK' => '阻塞',
    'UNBLOCK'=>'取消阻塞',
    'BLOCK_DESCRIPTION' => '阻塞后此IP将不能访问你的网站',
    ...
    'USE_MARKDOWN_WRITE' => '请使用 Markdown 格式书写',
    'FORCE_DISABLE_COMMENT' => '强制关闭显示评论',
    'FORCE_ENABLE_COMMENT' => '强制开启显示评论',
    'IS_SHOW_TOC' => '是否显示TOC',
    'CLOSE'=>'关闭',
    'SHOW' =>'显示',
    'PUBLISH'=> '发布',
    ...
    'UNVERIFIED_COMMENT'=>'条未审核评论？',
    'DELETE_UNVERIFIED'=>'删除未审核',
    'USER'=>'用户',
    'E_MAIL' => 'Email',
    'ADDRESS' => '地址',
    'STATUS' => '状态',
    ...
    'RECOVERY'=>'恢复',
    'SURE_DELETE_THIS_COMMENT'=>'确定删除此评论',
    ...
    'REVOKE'=>'撤销',
    'REVIEW'=>'预览',
    'REMOVE_TIPS' => '删除(这将永久刪除)',
    'HIDE_COMMENT' =>'不显示评论',
    'DISPLAY_COMMENT' => '显示评论',
    ...
    'INDEX'=>'目录',
    'COPYRIGHT'=>'版权声明',
    'COPYRIGHT_STATEMENT1'=>'自由转载-非商用-非衍生-保持署名',
    'COPYRIGHT_STATEMENT2'=>'创意共享3.0许可证',
    'CREATE_DATE'=>'创建日期',
    'EDIT_DATE'=>'修改日期',
    'READ_NUM'=>'阅读次数',
    ...
    'CHANGE_USER_IMG'=>'修改头像',
    'CHANGE_INFO_IMG'=>'修改简介图片',
    //view/user/render-notification.blade.php
    'READ_NOTIFICATION'=>'已读',
    'READ_ALL_NOTIFICATION'=>'全部已读',
    'DELETE_READ'=>'删除已读',
    ...
    'VIEWS' => '阅读量',
    //view/pay.blade.php
    'WRITE_WELL_DONATE' => '写的不错，赞助一下主机费',
    'DONATE' => '赞赏',
    'ZHIFUBAO' => '支付宝',
    'WECHAT' => '微信',
    'ZHIFUBAO_TABPANEL' => '扫一扫，用支付宝赞赏',
    'WECHAT_TABPANEL' => '扫一扫，用微信赞赏',
    ...
    'YOUR_EMAIL' => '邮箱不会公开',
    'WEBSITE' => '个人网站',
    'YOUR_WEBSITE' => '可选，填写后点击头像可以直接进入',
    'COMMENT_ARTICLE'=>'评论内容',
    'SUPPORT'=>'支持',
    'REVIEW_N_SHOW' => '审核后才会显示',
    'COMMENT_SUBMIT' => '回复',
    //view/recommended_posts.blade.php
    'RECOMMENDED_POSTS'=>'推荐阅读',
    //view/tags.balde.php
    'TAG'=>'标签',
    'NO_TAGS'=>'No tags.',
    //view/achieve.blade.php
    'TOTAL' => '共',
    'TOTAL_POSTS' => '篇文章',
    ...
    'PLEASE_CREATE_CATEGORY'=>'请先创建一个分类',
    'CREATE_SUCCESS'=>'创建成功',
    'CREATE_FAIL'=>'创建失敗',
    'PUBLISH_FAIL_REMOVE'=>'发布失败，请先恢复删除',
    'PUBLISH_SUCCESS'=>'发布成功',
    'REVOKE_PUBLISH_SUCCESS'=>'撤销发布成功.',
    'OPERATING_FAIL'=>'操作失败',
    'EDIT_SUCCESS'=>'修改成功',
    'EDIT_FAIL'=>'修改失败',
    ...
    'USE_GITHUB_SING_UP_SUCCESS'=>'使用Github注册成功',
    'USE_GITHUB_SING_UP_FAIL'=>'使用Github注册失败',
    'BIND_GITHUB_SUCCESS'=>'绑定 Github 成功',
    'BIND_GITHUB_FAIL'=>'绑定 Github 失败',
    //controller/HomeController.php
    'PLEASE_KEY_IN_KEYWORD'=>'请输入关键字',
    'PLEASE_KEY_IN_URL_OR_IMG'=>'请输入 URL 或者上传图片'
